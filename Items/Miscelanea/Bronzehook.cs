...
{
	internal class Bronzehook : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Bronze hook");
		}
		...
		public override void SetDefaults() {
			...
			*/
			...
			item.shoot = mod.ProjectileType("Bronzehookprojectile");
		}
	...
	internal class Bronzehookprojectile : ModProjectile
	{
		public override void SetStaticDefaults() {
		...
		public override bool? CanUseGrapple(Player player) {
			...
			if (hooksOut > 1) // This hook can have 3 hooks out.
			{
				return false;
			}
			return true;
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor) {
			...
			while (distance > 30f && !float.IsNaN(distance)) {
				...
				//Draw chain
				spriteBatch.Draw(mod.GetTexture("Items/Bronzehookchain"), new Vector2(center.X - Main.screenPosition.X, center.Y - Main.screenPosition.Y),
