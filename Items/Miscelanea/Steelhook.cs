	...
	internal class Steelhook : ModItem
	{
		...
		public override void SetDefaults() {
			...
			*/
			...
			item.shoot = mod.ProjectileType("Steelhookprojectile");
		}
	...
	internal class Steelhookprojectile : ModProjectile
	{
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor) {
			...
			while (distance > 30f && !float.IsNaN(distance)) {
				...
				//Draw chain
				spriteBatch.Draw(mod.GetTexture("Items/Steelhookchain"), new Vector2(center.X - Main.screenPosition.X, center.Y - Main.screenPosition.Y),
