...
namespace Bleachmod.NPCs
{
	...
	public class LivingEsmerald : ModNPC
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Living Esmerald");
		...
		public override void HitEffect(int hitDirection, double damage) {
			for (int i = 0; i < 10; i++) {
				...
				int dustIndex = Dust.NewDust(npc.position, npc.width, npc.height, mod.DustType("EmeraldDust"));
