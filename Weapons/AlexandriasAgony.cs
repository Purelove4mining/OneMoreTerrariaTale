...
{
	public class AlexandriasAgony : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Alexandrias Agony");
			Tooltip.SetDefault("With her lastbreath she toke his power");  //The (English) text shown below your weapon's name
		}
