...
{
	public class BronzeKatana : ModItem
	{
		public override void SetStaticDefaults() {
			
			DisplayName.SetDefault("Bronze Katana");
			Tooltip.SetDefault("I'll never forgive the japanese.."); 
		}
		
		public override void SetDefaults() {
			
			item.damage = 11;           //The damage of your weapon
			...
			item.value = Item.buyPrice(silver: 15);           //The value of the weapon
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(null, "Bronzebar", 11);
