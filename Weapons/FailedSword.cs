...
{
	public class FailedSword : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Failed Sword");
			Tooltip.SetDefault("Maybe later you could end your work");  //The (English) text shown below your weapon's name
		}

		public override void SetDefaults() {
			item.damage = 3;           //The damage of your weapon
			item.melee = true;          //Is your weapon a melee weapon?
			item.width = 34;            //Weapon's texture's width
			item.height = 38;           //Weapon's texture's height
		...
		public override void AddRecipes() {
		    ...
		    recipe.AddIngredient(null, "BlueScrap", 2);
			recipe.AddIngredient(null, "GreenScrap", 2);
			recipe.AddIngredient(null, "RedScrap", 2);
