...
{
	public class Kamadashi : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Kamadashi");
			Tooltip.SetDefault("Just a step below of his final form");  //The (English) text shown below your weapon's name
		}
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(null, "TrueBlade");
